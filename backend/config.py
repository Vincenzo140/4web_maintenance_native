...
class Config:
    ...
    DATABASE_URL=getenv('DATABASE_URL', 'postgresql+psycopg://postgres:bHkH242GdlkgVXMtGWKrGV96iL8F5-Dw@psql:5432/maintenance') 

    POSTGRES_PASSWORD=getenv('POSTGRES_PASSWORD', "bHkH242GdlkgVXMtGWKrGV96iL8F5-Dw")
    POSTGRES_USER=getenv('POSTGRES_USER', "postgres")
    POSTGRES_DB=getenv('POSTGRES_DB', "maintenance")
